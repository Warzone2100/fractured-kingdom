...
function setLimits()
{
	setDroidLimit(selectedPlayer, 100, DROID_ANY); //note: the transporter is a unit you own, but the player never gets a transporter in this mod!
	...
	for (var i = 0; i < maxPlayers; ++i)
	{
		...
		//non human players get more of these
		setStructureLimits("A0CommandCentre", i === selectedPlayer ? 1 : 5, i);
		setStructureLimits("A0ComDroidControl", i === selectedPlayer ? 1 : 5, i);
		setStructureLimits("A0PowerGenerator", i === selectedPlayer ? 8 : 20, i);
		setStructureLimits("A0ResearchFacility", i === selectedPlayer ? 5 : 20, i);
		setStructureLimits("A0LightFactory", i === selectedPlayer ? 5 : 20, i);
		setStructureLimits("A0CyborgFactory", i === selectedPlayer ? 5 : 20, i);
		setStructureLimits("A0VTolFactory1", i === selectedPlayer ? 5 : 20, i);
